...
var MyPromise = /** @class */ (function () {
    ...
    MyPromise.prototype._resolve = function (value) {
        ...
        this._state = PromiseState.FULFILLED;
        this._value = value;
        this._successCallbacks.forEach(function (cb) { return cb(value); });
        this._finallyCallbacks.forEach(function (cb) { return cb(); });
    };
    MyPromise.prototype._reject = function (reason) {
        ...
        this._state = PromiseState.REJECTED;
        this._reason = reason;
        this._failureCallbacks.forEach(function (cb) { return cb(reason); });
        this._finallyCallbacks.forEach(function (cb) { return cb(); });
    };
    MyPromise.prototype.then = function (handler) {
        if (this._state == PromiseState.FULFILLED && this._value !== undefined) {
            handler(this._value);
        }
        else {
    ...
    MyPromise.prototype["catch"] = function (handler) {
    ...
    MyPromise.prototype["finally"] = function (handler) {
        if (this._state !== PromiseState.PENDING) {
            handler();
        }
        else {
...
p.then(function (data) { return console.log(data); })["catch"](function (err) { return console.log(err); })["finally"](function () { return console.log("hello"); });
